...
- `rm()`で何かを消したら、それを**取り戻すことができない**（リナックスの`rm`と同様に）
...
「部分集合化」（subsetting）とは、**ベクトルの中から欲しいところだけを切り取ること**
...
以下のうち、agesから**２つ目の数値だけ**を抜き出す事ができるのはどれでしょう？
